...
//  REQUIRE ( Sinus<3>(0.0) == Approx(std::sin(0.0)).epsilon(1e-3) );
//  REQUIRE ( Sinus<5>(-2.0) == Approx(std::sin(-2.0)).epsilon(1e-3) );
//  REQUIRE ( Sinus<4>(1.0) == Approx(std::sin(1.0)).epsilon(1e-3) );
// }
